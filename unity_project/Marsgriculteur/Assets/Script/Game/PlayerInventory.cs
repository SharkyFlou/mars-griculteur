...
namespace game
{
    public class PlayerInventory : MonoBehaviour
    {
        ...
        public Inventory PlantationInventory;
        ...
        void Start()
        {
            ...
            //on prend chaque type d'inventory et on le reaffiche/modifie
            afficheDansToutInventory();

        }


        public void afficheDansToutInventory()
        {
            inventory.afficheInventory(dicoPossessions);
            PlantationInventory.afficheInventory(dicoPossessions);
        }
